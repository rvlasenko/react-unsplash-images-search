...
const Gallery = () => {
  ...
  if (isLoading) {
    return (
      <div className="flex justify-center mt-16" role="status" aria-label="Loading images">
  ...
  return (
    <section className="mt-10 columns-1 sm:columns-2 lg:columns-3 gap-4 space-y-4">
